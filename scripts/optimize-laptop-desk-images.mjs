/**
 * Replace laptop-desk placeholders when sources exist in shopnoorva-laptop-desk/sources/
 * Usage: node scripts/optimize-laptop-desk-images.mjs
 */
...
const SRC = path.join(ROOT, "shopnoorva-laptop-desk/sources");
