...
export const PRODUCT_PROFILES: ProductProfile[] = [
  ...
  },
  {
    ...
    type: "Laser Star Galaxy Projector with Bluetooth Speaker & Timer",
    color: "Matte Black brushed aluminium",
    category: "Galaxy Projectors",
    categoryId: "cat-projectors",
    shortDescription: "Brushed aluminium body — model R-ILED05, green/red laser stars + RGB nebula, built-in Bluetooth speaker, remote with auto-off timer",
    visualIdentity:
      "Exact product: sleek brushed-aluminium cylindrical galaxy star projector with built-in Bluetooth speaker (model R-ILED05). Anodized metal housing with matte black top cap emitting sharp green and red laser star points combined with soft blue-purple RGB nebula cloud light. Front control panel with power button, mode button and a small circular speaker mesh. Slim black IR remote control with buttons for color, speed, auto-off timer and volume. USB-C DC5V power input on the rear. Premium modern finish, compact tabletop size around 13x13x14cm. DO NOT redesign — exact replica of commercial product photography.",
    dimensions: "13 × 13 × 14 سم",
    accessories: ["IR remote control with timer", "USB-C power cable", "User manual"],
    packageItems: ["Aluminium star projector", "Remote control", "USB-C cable", "Instruction manual"],
    sourceUrls: {},
  },
  {
    id: "prod-aurora",
