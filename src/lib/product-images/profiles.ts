...
export const PRODUCT_PROFILES: ProductProfile[] = [
  {
    ...
    shortDescription: "White bear-ear astronaut — chest Bluetooth speaker, lunar base, 8 nebula modes, black remote, 360° magnetic head",
    visualIdentity:
      "EXACT real product — white chibi astronaut galaxy projector Bluetooth speaker. Two small rounded bear-ear protrusions on top of white helmet. Large dark glossy black reflective visor with nebula projection lens inside. Small circular lens on top of helmet between ears. Large circular perforated chest speaker grille with concentric holes. White lunar crater textured circular base. Grey braided cable connecting head to body. Rectangular backpack with control buttons ON/OFF Model Light Music/Sound and USB port. Black slim vertical remote with red power button R G B W S+ S- mode buttons. 360° magnetic free-rotating head. 8 nebula projection modes with crescent moon. Dimensions 24cm height × 12cm base. Matte white ABS plastic. Standing pose. DO NOT redesign — exact replica.",
    dimensions: "24 × 12 × 12 سم",
    accessories: ["Black IR remote control", "USB cable", "User manual"],
    packageItems: ["Astronaut projector with Bluetooth chest speaker", "Remote control", "USB power cable", "Instruction manual"],
    sourceUrls: {
      "01-hero-white-bg": "https://m.media-amazon.com/images/I/81gRORu5X7L._AC_SL1500_.jpg",
      "02-premium-hero": "https://m.media-amazon.com/images/I/71icsbrywBL._AC_SL1500_.jpg",
      ...
      "14-product-in-use": "https://m.media-amazon.com/images/I/416l9BGn6uL._AC_SL1500_.jpg",
      "17-infographic": "https://m.media-amazon.com/images/I/51JstmLGBSL._AC_SL1500_.jpg",
    },
  },
  {
    id: "prod-crystal",
