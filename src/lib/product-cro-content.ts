...
export const PRODUCT_CRO: Record<string, CroProductContent> = {
  ...
  "mini-egg-boiler": {
    headline: {
      title: "فطور الصباح ولى أسهل",
      subtitle:
        "حضّر عدة بيضات بطريقة عملية: زر أحمر واحد، غطاء شفاف، وصينية حتى 7 بيضات. قطعة بـ199 درهم، جوج بـ299، أو 3 بـ399 — الدفع عند الاستلام داخل المغرب.",
    },
    midCtaLabels: [
      "جاهز تسهّل فطور الصباح؟",
      "الثمن واضح — والطلب في دقيقة",
      "باش ما تتردّدش — الدفع غير ملي يوصلك",
    ],
    howTo: [
      {
        step: "1",
        title: "حط البيض فالجهاز",
        desc: "حط البيض فالصينية، حسب العدد اللي بغيتي — حتى 7 بيضات.",
        imageKey: "07-romantic-room",
      },
      {
        step: "2",
        title: "شغّل الجهاز",
        desc: "ضغط على الزر الأحمر اللي فالواجهة.",
        imageKey: "09-close-up",
      },
      {
        step: "3",
        title: "خليه يكمل عملية الطهي",
        desc: "خلي الجهاز يكمّل الخدمة ديالو حسب إعداداته. الغطاء الشفاف كيخلّيك تشوف البيض.",
        imageKey: "14-product-in-use",
      },
      {
        step: "4",
        title: "وجد الفطور ديالك",
        desc: "خرج البيض وقدّم الفطور — للدار، للمدرسة، أو قبل الخدمة.",
        imageKey: "04-bedroom",
      },
    ],
    comparison: {
      oursLabel: "جهاز طهي البيض NOORVA",
      rows: [
        { label: "صينية حتى 7 بيضات دفعة وحدة", us: true, them: "بيضة بيضة فالبوطة" },
        { label: "زر تشغيل أحمر واحد", us: true, them: "إعدادات معقدة" },
        { label: "غطاء شفاف كتشوف البيض", us: true, them: false },
        { label: "جهاز مخصص فوق طاولة الكوزينة", us: true, them: "طنجرة كبيرة" },
        { label: "199 درهم · جوج بـ299 · 3 بـ399", us: true, them: "بلا عرض واضح" },
        ...SHARED_TRUST_ROWS,
      ],
    },
    benefits: [
      {
        icon: Egg,
        title: "تحضير عدة بيضات",
        desc: "صينية فيها حتى 7 بيضات دفعة وحدة، حسب سعة الجهاز.",
      },
      {
        icon: Timer,
        title: "يساعدك تستغل وقت الصباح",
        desc: "شغّل الجهاز وكمل باقي التحضيرات وأنت مستني.",
      },
      {
        icon: Users,
        title: "مناسب لفطور العائلة",
        desc: "تحضّر البيض للدار كاملة بلا ما تقف قدام البوطة.",
      },
      {
        icon: Home,
