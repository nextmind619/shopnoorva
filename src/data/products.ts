...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: L("بروجيكتور نجوم الألمنيوم بالليزر", "Projecteur Étoiles Aluminium Laser", "Aluminium Bluetooth Star Projector"),
    shortDescription: L(
      "جسم ألمنيوم أسود — ليزر أخضر/أحمر + سبيكر بلوتوث + ريموت بمؤقت",
      "Corps aluminium noir — laser vert/rouge, Bluetooth, minuterie",
      "Black aluminium body — green/red laser, Bluetooth speaker, timer remote"
    ),
    description: L(
      "بروجيكتور نجوم الألمنيوم من NOORVA (موديل R-ILED05) بتصميم فاخر من الألمنيوم المصقول. يعرض نقاط ليزر أخضر وأحمر حادة مع سديم RGB ناعم على السقف والجدران. سبيكر بلوتوث مدمج، ريموت تحكم بمؤقت إيقاف تلقائي. مثالي للغرف، الألعاب، والتصوير.",
      "Projecteur étoiles en aluminium NOORVA (R-ILED05), finition premium en métal poli. Points laser vert et rouge nets avec nébuleuse RGB douce. Haut-parleur Bluetooth intégré, télécommande avec minuterie automatique. Idéal chambre, gaming et contenu.",
      "NOORVA aluminium star projector (model R-ILED05), premium brushed-metal finish. Crisp green and red laser star points with soft RGB nebula. Built-in Bluetooth speaker, remote with auto-off timer. Perfect for rooms, gaming and content creation."
    ),
    categoryId: "cat-projectors",
    price: 159,
    compareAtPrice: 229,
    ...
    problemCause: L("البروجيكتورات الرخيصة كتستعمل ليد عادي، ما كاينش ليزر حقيقي", "Les projecteurs cheap utilisent des LED, pas de vrai laser", "Cheap projectors use plain LEDs, not real lasers"),
    problemSolution: L("جسم ألمنيوم + ليزر حقيقي + سبيكر بلوتوث + مؤقت", "Aluminium + vrai laser + Bluetooth + minuterie", "Aluminium body + real laser + Bluetooth + timer"),
    deepDescription: L(
      "جسم ألمنيوم مصقول (R-ILED05) يعرض ليزر أخضر وأحمر حاد مع سديم RGB. سبيكر بلوتوث، ريموت بمؤقت إيقاف تلقائي — جودة فندقية على مكتبك.",
      "Corps aluminium (R-ILED05), laser vert rouge net, nébuleuse RGB. Bluetooth, minuterie automatique.",
      "Brushed aluminium body (R-ILED05), crisp green red laser, RGB nebula. Bluetooth speaker, auto-off timer."
    ),
    tags: ["star", "laser", "bluetooth", "aluminium", "timer", "galaxy", "bedroom", "decor", "gift", "relaxation"],
    benefits: [
      L("ليزر حقيقي أخضر وأحمر", "Vrai laser vert et rouge", "Real green and red laser"),
      ...
      L("جسم ألمنيوم فاخر", "Corps en aluminium premium", "Premium aluminium body"),
    ],
    features: [
      L("ليزر أخضر/أحمر + سديم RGB", "Laser vert/rouge + nébuleuse RGB", "Green/red laser + RGB nebula"),
      L("بلوتوث + سبيكر مدمج", "Bluetooth + haut-parleur", "Bluetooth + built-in speaker"),
      L("ريموت بمؤقت إيقاف تلقائي", "Télécommande avec minuterie", "Remote with auto-off timer"),
      L("جسم ألمنيوم مصقول", "Corps aluminium poli", "Polished aluminium body"),
    ],
    specifications: [
      { label: L("الموديل", "Modèle", "Model"), value: L("R-ILED05", "R-ILED05", "R-ILED05") },
      { label: L("المادة", "Matériau", "Material"), value: L("ألمنيوم مصقول", "Aluminium poli", "Brushed aluminium") },
      { label: L("الطاقة", "Alimentation", "Power"), value: L("USB-C DC 5V", "USB-C DC 5V", "USB-C DC 5V") },
      { label: L("نوع الليزر", "Type de laser", "Laser Type"), value: L("أخضر + أحمر", "Vert + rouge", "Green + red") },
      { label: L("البلوتوث", "Bluetooth", "Bluetooth"), value: L("5.0 + سبيكر مدمج", "5.0 + haut-parleur", "5.0 + built-in speaker") },
      { label: L("المؤقت", "Minuterie", "Timer"), value: L("نعم — إيقاف تلقائي", "Oui — arrêt auto", "Yes — auto-off") },
      { label: L("الأبعاد", "Dimensions", "Dimensions"), value: L("13×13×14 سم", "13×13×14 cm", "13×13×14 cm") },
      { label: L("الضمان", "Garantie", "Warranty"), value: L("12 شهر", "12 mois", "12 months") },
    ],
    packageIncludes: [
      L("بروجيكتور نجوم الألمنيوم", "Projecteur aluminium", "Aluminium star projector"),
    ...
    lifestyleImages: [],
    lifestyleScenes: [
      { id: "bedroom", emoji: "🛏️", title: L("غرفة النوم", "Chambre", "Bedroom"), description: L("ليزر ناعم يساعد على النوم مع مؤقت إيقاف", "Laser doux avec minuterie pour dormir", "Soft laser with sleep timer") },
    ...
    crossSellIds: ["prod-rabbit"],
    seo: {
      title: L("بروجيكتور نجوم الألمنيوم بالليزر | NOORVA", "Projecteur Étoiles Aluminium Laser | NOORVA", "Aluminium Bluetooth Star Projector | NOORVA"),
      description: L("بروجيكتور نجوم ألمنيوم بليزر حقيقي وبلوتوث ومؤقت — الدفع عند الاستلام", "Projecteur aluminium laser + Bluetooth + minuterie — COD", "Aluminium laser projector + Bluetooth + timer — COD"),
    },
  },
  {
    id: "prod-aurora",
...
export const reviews: ProductReview[] = [
  ...
  { id: "r4", productId: "prod-starbt", author: "أمين التازي", city: "طنجة", rating: 5, title: L("جودة عالية", "Haute qualité", "High quality"), content: L("بروجيكتور الليزر الألمنيوم كيشعل الغرفة كاملة والمؤقت مفيد بزاف.", "Le projecteur laser aluminium illumine toute la pièce, la minuterie est top.", "Aluminium laser projector lights the whole room, the timer is very useful."), date: "2026-06-08", verified: true, images: [resolveProductImage("bluetooth-star-projector", "05-living-room", "thumbnail")] },
