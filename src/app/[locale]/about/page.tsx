...
const content: Record<string, { title: string; paragraphs: string[] }> = {
  ar: {
    title: "قصتنا",
    paragraphs: [
      "NOORVA علامة مغربية لإضاءة الأجواء: بروجيكتور رائد الفضاء بلوتوث MX003، بروجيكتور المجرة والنجوم متعدد الألوان، بروجيكتور الأورورا الأبيض الهندسي، وكاروسيل الأرانب الموسيقي.",
  ...
  fr: {
    ...
    paragraphs: [
      "NOORVA est une marque marocaine d'éclairage d'ambiance: projecteur astronaute Bluetooth MX003, projecteur galaxie multicolore, projecteur aurore géométrique blanc et carrousel musical lapin.",
  ...
  en: {
    title: "Our Story",
    paragraphs: [
      "NOORVA is a Moroccan ambient lighting brand: the MX003 astronaut Bluetooth speaker projector, the multi-color galaxy star projector, the white geometric Dream Aurora projector and the rabbit carousel music-box night light.",
