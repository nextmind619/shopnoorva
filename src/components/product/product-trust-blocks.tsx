...
function getStory(slug: string) {
  ...
  if (slug === "bt12-4in1-selfie-stick-tripod") {
    return {
      eyebrow: "التصوير",
      title: "سيلفي، ترايبود، وصحابك… فجهاز واحد",
      paragraphs: [
        "BT12 كتجمع عصا سيلفي قابلة للتمديد، وضع الترايبود، وصورة جماعية، مع ضوئين دائريين وريموت لاسلكي. كتطوى وتتحط فالشنتة.",
        "الثمن 349 درهم والدفع عند الاستلام. وزيد عليها هدية مجانية مفاجأة مع الطلب ديالك: كابل USB-C 240W مع حامل هاتف قابل للطي. الهدية مجانية وما غادي تخلص عليها حتى درهم زايد.",
      ],
    };
  }
